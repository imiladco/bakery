...
final class Workbook
{
    ...
    private function definitions(string $period): array
    {
        ...
        $definitions[] = [
            // «فعلی» در عنوان عمدی‌ست. سقف مثل مصرف به ماه مهر نشده و
            // مقدار امروز است؛ اگر مدیر بعداً سقف کسی را عوض کند،
            // گزارشِ همان ماه دفعهٔ بعد عدد تازه را نشان می‌دهد. ستون
            // باید همین را بگوید، نه اینکه ادعای تاریخی بودن کند.
            'spec' => new Column(__('سقف اعتبار ماهانه (فعلی)', 'bakery-widgets'), numeric: true, width: 22),
