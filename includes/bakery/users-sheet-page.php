...
final class Users_Sheet_Page
{
    ...
    private function render_import_card(): void
    {
        ...
        <div class="card" style="max-width:820px">
            ...
            <p>
                <?php esc_html_e('هر سطر با «کد ملی» یا «شماره تماس» به کاربرش وصل می‌شود. چون هر دو کار می‌کنند، می‌توانید کد ملیِ اشتباه را همین‌جا اصلاح کنید و سطر با شمارهٔ تماس پیدا می‌شود — و برعکس. سطری که به هیچ کاربری نخورد، کاربر تازه می‌سازد؛ و سطری که به دو کاربرِ مختلف بخورد نوشته نمی‌شود و در پیش‌نمایش با نامشان نشان داده می‌شود. سلول خالی یعنی «این مقدار را عوض نکن» — پس با پاک کردن یک ستون، چیزی پاک نمی‌شود.', 'bakery-widgets'); ?>
            </p>
