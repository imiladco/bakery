...
final class Users_Sheet_Page
{
    ...
    private function render_import_card(): void
    {
        ...
        <div class="card" style="max-width:820px">
            ...
            <p>
                <?php esc_html_e('هر سطر اول با ستون «شناسه» به کاربرش وصل می‌شود — خروجی خودش آن را پر می‌کند و در فایل اکسل قفل است، پس نه لازم است دستش بزنید و نه می‌شود. با وجود شناسه می‌توانید هر ستون دیگری، حتی کد ملی و شماره تماس را با هم، آزادانه عوض کنید. سطری که خودتان اضافه می‌کنید شناسه ندارد و با کد ملی یا شماره تماس تطبیق داده می‌شود؛ اگر به هیچ کاربری نخورد، کاربر تازه می‌سازد. سلول خالی یعنی «این مقدار را عوض نکن» — پس با پاک کردن یک ستون، چیزی پاک نمی‌شود.', 'bakery-widgets'); ?>
            </p>
