...
final class Order_History extends Widget_Base
{
    ...
    private function render_step_icon(string $name): void
    {
        $icons = [
            ...
            // این یکی در فیگما با viewBox ۱۲ اکسپورت شده بود؛ مختصاتش
            // با نسبت ۱۴/۱۲ مقیاس شد تا با بقیه در یک viewBox بنشیند.
            // اگر به‌جایش viewBox خودش می‌ماند، ضخامت خطش نسبت به
            // بقیه ۱۷٪ کلفت‌تر رندر می‌شد.
            'package' => '<path d="M7 12.8338V7.00013M7 7.00013L1.91919 4.0833M7 7.00013L12.08083 4.0833M4.375 2.49043L9.625 5.49477M6.41667 12.67618C6.59402 12.77862 6.7952 12.83252 7 12.83252C7.2048 12.83252 7.40598 12.77862 7.58333 12.67618L11.66667 10.34277C11.84388 10.24046 11.991 10.09337 12.09343 9.91624C12.19575 9.73909 12.24977 9.53814 12.25 9.33354V4.66661C12.24977 4.462 12.19575 4.26105 12.09343 4.08392C11.991 3.90678 11.84388 3.75968 11.66667 3.65738L7.58333 1.32391C7.40598 1.22151 7.2048 1.1676 7 1.1676C6.7952 1.1676 6.59402 1.22151 6.41667 1.32391L2.33333 3.65738C2.15615 3.75968 2.00899 3.90678 1.9066 4.08392C1.80422 4.26105 1.75021 4.462 1.75 4.66661V9.33354C1.75021 9.53814 1.80422 9.73909 1.9066 9.91624C2.00899 10.09337 2.15615 10.24046 2.33333 10.34277L6.41667 12.67618Z" stroke="currentColor" stroke-linecap="round"/>',
